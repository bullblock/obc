...
module "vpc" {
  ...
  vpc_name          = "paraview-api-standalone-trial-vpc"
  ...
  subnet_name           = "paraview-api-standalone-trial-subnet"
...
module "ecs-security-group" {
  ...
  secgroup_name           = "paraview-api-standalone-trial-secgroup"
...
module "ecs" {
  ...
  instance_name = "paraview-api-standalone-trial"
...
module "eip" {
  ...
  eip_name    = "paraview-api-standalone-trial-eip"

  publicip_type         = local.publicip_type
  # bandwidth_name        = format("%s-%s", local.app_id, "bandwidth")
  bandwidth_name        = "paraview-api-standalone-trial-bandwidth"

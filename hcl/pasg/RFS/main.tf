...
module "vpc" {
  ...
  vpc_name          = "paraview-pasg-standalone-trial-vpc"
  ...
  subnet_name           = "paraview-pasg-standalone-trial-subnet"
...
module "ecs-security-group" {
  ...
  secgroup_name           = "paraview-pasg-standalone-trial-secgroup"
...
module "ecs" {
  ...
  instance_name = "paraview-pasg-standalone-trial"
...
module "eip" {
  ...
  eip_name    = "paraview-pasg-standalone-trial-eip"

  publicip_type         = local.publicip_type
  # bandwidth_name        = format("%s-%s", local.app_id, "bandwidth")
  bandwidth_name        = "paraview-pasg-standalone-trial-bandwidth"
